...
/**
    ...
    {
        list($response) = $this->getDivisionWithHttpInfo($division_id, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDivisionAsync($division_id, string $contentType = self::contentTypes['getDivision'][0])
    {
        return $this->getDivisionAsyncWithHttpInfo($division_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDivisionRequest($division_id, string $contentType = self::contentTypes['getDivision'][0])
    {

        // verify the required parameter 'division_id' is set
        if ($division_id === null || (is_array($division_id) && count($division_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $division_id when calling getDivision'
            );
        }


        $resourcePath = '/v1/divisions/{divisionId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
