...
/**
 * CreateFocusArea Class Doc Comment
 *
 * @category Class
 * @package  Verdigado\GrueneApiClient
 * @author   OpenAPI Generator team
 ...
 */
class CreateFocusArea implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateFocusArea';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['score'] > 5)) {
            $invalidProperties[] = "invalid value for 'score', must be smaller than or equal to 5.";
        }
    ...
    public function setScore($score)
    {
        ...
        if (($score > 5)) {
            throw new \InvalidArgumentException('invalid value for $score when calling CreateFocusArea., must be smaller than or equal to 5.');
        }
        if (($score < 1)) {
            throw new \InvalidArgumentException('invalid value for $score when calling CreateFocusArea., must be bigger than or equal to 1.');
        }
