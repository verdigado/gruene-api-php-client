 ...
 */
class UpdateFocusArea implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateFocusArea';
    ...
    */
    ...
    public function setScore($score)
    {
        ...
        if (($score > 5)) {
            throw new \InvalidArgumentException('invalid value for $score when calling UpdateFocusArea., must be smaller than or equal to 5.');
        }
        if (($score < 1)) {
            throw new \InvalidArgumentException('invalid value for $score when calling UpdateFocusArea., must be bigger than or equal to 1.');
        }
