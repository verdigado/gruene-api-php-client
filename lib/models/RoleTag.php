 ...
 */
class RoleTag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RoleTag';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Id of the role tag
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Name of the role tag
     *
     * @return self
     */
