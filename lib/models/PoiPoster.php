 ...
 */
class PoiPoster implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PoiPoster';
    ...
    */
     ...
     * Sets status
     *
     * @param string $status Current status of the poster.
     *
     * @return self
     */
     ...
     * Sets comment
     *
     * @param string $comment A short text to describe the state of the poster.
     *
     * @return self
     */
