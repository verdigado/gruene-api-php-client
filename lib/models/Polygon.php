 ...
 */
class Polygon implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Polygon';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('type', $data ?? [], 'Polygon');
    }
    ...
    */
     ...
     * Sets coordinates
     *
     * @param float[][][] $coordinates Coordinates of the polygon Must follow the GeoJSON standard
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type Type of the polygon
     *
     * @return self
     */
