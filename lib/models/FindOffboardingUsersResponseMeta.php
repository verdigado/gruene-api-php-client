...
/**
 * FindOffboardingUsersResponseMeta Class Doc Comment
 *
 * @category Class
 * @package  Verdigado\GrueneApiClient
 * @author   OpenAPI Generator team
 ...
 */
class FindOffboardingUsersResponseMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('cursor_next', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['cursor_next'];
    }

    /**
     * Sets cursor_next
     *
     * @param string|null $cursor_next cursor_next
     *
     * @return self
     */
    public function setCursorNext($cursor_next)
    {
        if (is_null($cursor_next)) {
            throw new \InvalidArgumentException('non-nullable cursor_next cannot be null');
        }
        $this->container['cursor_next'] = $cursor_next;
