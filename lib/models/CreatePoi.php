 ...
 */
class CreatePoi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePoi';
    ...
    */
    ...
    public function setCoords($coords)
    {
        ...
        if ((count($coords) > 2)) {
            throw new \InvalidArgumentException('invalid value for $coords when calling CreatePoi., number of items must be less than or equal to 2.');
        }
        if ((count($coords) < 2)) {
            throw new \InvalidArgumentException('invalid length for $coords when calling CreatePoi., number of items must be greater than or equal to 2.');
        }
     ...
     * Sets poster
     *
     * @param PoiPoster|null $poster poster
     *
     * @return self
     */
     ...
     * Sets flyer_spot
     *
     * @param PoiFlyerSpot|null $flyer_spot flyer_spot
     *
     * @return self
     */
     ...
     * Sets house
     *
     * @param PoiHouse|null $house house
     *
     * @return self
     */
