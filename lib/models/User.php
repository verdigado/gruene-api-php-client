...
class User implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets disabled
     *
     * @param bool|null $disabled Flag that indicates if the user is not in sherpa anymore or has no active memberships.
     *
     * @return self
     */
     ...
     * Sets email
     *
     * @param string $email Main user email address. Used to log in to Grünes Netz (gnetz email)
     *
     * @return self
     */
