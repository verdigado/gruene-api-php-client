 ...
 */
class RoleCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RoleCategory';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The role category id
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string $label Name of the role category
     *
     * @return self
     */
