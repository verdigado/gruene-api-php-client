...
/**
 * OffboardingUserInfoDto Class Doc Comment
 *
 * @category Class
 * @package  Verdigado\GrueneApiClient
 * @author   OpenAPI Generator team
 ...
 */
class OffboardingUserInfoDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OffboardingUserInfoDto';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The User Id (Sherpa Id)
     *
     * @return self
     */
     ...
     * Sets username
     *
     * @param string $username The users username. Used to log in to Grünes Netz (gnetz username)
     *
     * @return self
     */
