...
/**
 * GnetzApplicationCategory Class Doc Comment
 *
 * @category Class
 * @package  Verdigado\GrueneApiClient
 * @author   OpenAPI Generator team
 ...
 */
class GnetzApplicationCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GnetzApplicationCategory';
    ...
    */
     ...
     * Sets order
     *
     * @param float $order The category order used for display purposes
     *
     * @return self
     */
