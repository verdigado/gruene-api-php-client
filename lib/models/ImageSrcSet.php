 ...
 */
class ImageSrcSet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImageSrcSet';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('srcset', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['srcset'] === null) {
            $invalidProperties[] = "'srcset' can't be null";
        }
    ...
    {
        if (is_null($srcset)) {
            throw new \InvalidArgumentException('non-nullable srcset cannot be null');
        }
        $this->container['srcset'] = $srcset;
